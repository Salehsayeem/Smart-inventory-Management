        ...
        public async Task SetPermissions(int roleId, Ulid userId)
        {
            try
            {
                ...
                var permissions = modules.Select(module => new Permission()
                {
                    ...
                    UserId = userId,
                    RoleId = roleId,
                    IsCreate = roleId == (int)RoleEnums.Admin || module.Id == 1,
                    IsView = roleId == (int)RoleEnums.Admin || module.Id == 1,
                    IsEdit = roleId == (int)RoleEnums.Admin || module.Id == 1,
                    IsList = roleId == (int)RoleEnums.Admin || module.Id == 1,
                    IsDelete = roleId == (int)RoleEnums.Admin || module.Id == 1
                }).ToList();
